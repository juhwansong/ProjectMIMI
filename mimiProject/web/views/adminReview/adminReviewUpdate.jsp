...
function openAddress()
{
    ...
    openWin = window.open('/mimi/views/adminReview/storeAddress.jsp','_blank'
		...
		<table class="table table-borderless" id="table-css3">
			<tr>
				...
				<td width="*"><input type="text" class="form-control"
					id="admin_title" placeholder="제목" name="title" value="<%= board.getTitle() %>"></td>
				<th width="15%">작성자</th>
...
if ($("#latitude").val() !== ""){
	...
	addMarker(locPosition, 0);
   	daum.maps.event.trigger(markers[0], "click");
