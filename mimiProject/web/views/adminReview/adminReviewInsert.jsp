...
function openAddress()
{
    ...
    openWin = window.open('/mimi/views/adminReview/storeAddress.jsp','지도표시창'
...
<div class="container" style="width:1150px;">
	<h3>MIMI리뷰 작성</h3>
	<form action="/mimi/adminboardinsert" method="post" enctype="multipart/form-data">
	<div id="inner">
		<table class="table table-borderless" id="table-css3">
			<tr>
				<th width="15%">제목</th>
				<td width="*"><input type="text" class="form-control" id="admin_title" placeholder="제목" name="title"></td>
				<th width="15%">작성자</th>
...
$(document).on("click", "#result-btn", function(){
	if($("#admin_title").val() == ""){
		...
		form.method = "post";
		form.action = "/mimi/adminboardinsert";
