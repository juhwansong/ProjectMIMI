...
<table width="100%">
	<tr style="vertical-align:top;">
		...
		<button type="button" class="btn btn-default pull-right" onClick="location.href='/mimi/supdate?sno=<%= support.getBoardNo() %>'" name="btnModify" style="outline:none; padding: 7px; margin:2px;">수정</button>
