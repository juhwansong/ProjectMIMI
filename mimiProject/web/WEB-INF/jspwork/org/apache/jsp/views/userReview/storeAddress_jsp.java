...
<<<<<<< HEAD
 * Generated at: 2018-08-30 07:56:22 UTC
=======
 * Generated at: 2018-08-30 08:46:51 UTC
>>>>>>> refs/heads/kcs
...
<<<<<<< HEAD
    _jspx_dependants.put("/views/userReview/../../nonHeaderHead.jsp", Long.valueOf(1535615458972L));
    _jspx_dependants.put("/views/userReview/../../end.jsp", Long.valueOf(1535615463203L));
=======
    _jspx_dependants.put("/views/userReview/../../nonHeaderHead.jsp", Long.valueOf(1535561217412L));
...
>>>>>>> refs/heads/kcs
	...
	String nickName = (String)session.getAttribute("nickName");
      ...
      out.write("    .infowin .desc {position: relative;left:-48px;text-align:center;margin: 13px 0 0 90px;height: 75px;background: #2b2d36;               overflow: hidden;text-overflow: ellipsis;white-space: nowrap;}\r\n");
      ...
      out.write("    \t\t<div class=\"custom_zoomcontrol radius_border\" style=\"opacity:0.8;right:20px;top:10px;\"> \r\n");
      out.write("       \t\t\t<span onclick=\"zoomIn()\"><img style=\"position:relative;height:100%;\" src=\"http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/ico_plus.png\" alt=\"확대\"></span>  \r\n");
      out.write("        \t\t<span onclick=\"zoomOut()\"><img style=\"position:relative;height:100%;\" src=\"http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/ico_minus.png\" alt=\"축소\"></span>\r\n");
      out.write("    \t\t</div>  \t\t\r\n");
      ...
      out.write("\tdocument.getElementById(\"latitude\").value = opener.document.getElementById(\"latitude\").value;\r\n");
      out.write("\tdocument.getElementById(\"longitude\").value = opener.document.getElementById(\"longitude\").value;\r\n");
      out.write(" });\r\n");
      ...
      out.write("var lat, lon;\r\n");
      out.write("\r\n");
      out.write("if(opener.document.getElementById(\"latitude\").value != \"\"){\r\n");
      out.write("\t\tlat = opener.document.getElementById(\"latitude\").value;\r\n");
      out.write("\t\tlon = opener.document.getElementById(\"longitude\").value;\r\n");
      out.write("\t\t\r\n");
      out.write("\t    locPosition = new daum.maps.LatLng(lat, lon),    \r\n");
      out.write("\t  \t//현재 위치 표시\r\n");
      out.write("\t  \taddClickMarker(locPosition, 0);\r\n");
      ...
      out.write("    if (status === daum.maps.services.Status.OK) {\r\n");
      out.write("\t\t\r\n");
      out.write("    \t//새 검색 시 기존 윈도우 인포들을 전부 지움\r\n");
      ...
      out.write("        (function(marker, title, id) {\r\n");
      out.write("               \r\n");
      ...
      out.write("            \t\r\n");
      out.write("            \tfor(var i=0; i<places.length; i++){\r\n");
      out.write("\t            \tif(places[i].id === id && placelistclicked !== i){\r\n");
      ...
      out.write("            };\r\n");
      out.write("            \r\n");
      out.write("        })(marker, places[i].place_name, places[i].id);\r\n");
      out.write("\r\n");
