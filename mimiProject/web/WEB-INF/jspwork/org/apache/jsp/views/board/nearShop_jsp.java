...
<<<<<<< HEAD
 * Generated at: 2018-08-30 10:16:30 UTC
=======
 * Generated at: 2018-08-30 11:01:15 UTC
>>>>>>> refs/heads/kcs
...
>>>>>>> refs/heads/kcs
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(userId == null){
      ...
      out.write("    \t\t<div class=\"custom_zoomcontrol radius_border\" style=\"top:30px;right:30px;opacity:0.8;\"> \r\n");
      ...
      out.write("\t          \t\t}\r\n");
      out.write("\t          \t\t\r\n");
      out.write("\t          \t\tvar currentPage = Number(data.list[0].currentPage);\r\n");
      out.write("\t          \t\tvar maxPage = Number(data.list[0].maxPage);\r\n");
      out.write("\t          \t\tvar startPage = Number(data.list[0].startPage);\r\n");
      out.write("\t          \t\tvar endPage = Number(data.list[0].endPage);\r\n");
      out.write("\t          \t\tvar totalCount = Number(data.list[0].totalCount);\r\n");
      out.write("\t          \t\t          \t\t\r\n");
      out.write("\t          \t\t//페이지 번호를 표출합니다\r\n");
      out.write("\t          \t\tpage = new pagination(data.list, currentPage, maxPage, startPage, endPage, totalCount);\r\n");
      out.write("\t          \t\tdisplayPlaces(data.list); //처음에 보여줄땐 바로 1페이지 목록 보이게\r\n");
      out.write("\t          \t\t\r\n");
      ...
      out.write("\t\tconstructor(list, current, max, start, end, total){\r\n");
      out.write("\t\t\tthis.list = list;\r\n");
      out.write("\t\t\tthis.current = current;\r\n");
      out.write("\t\t\tthis.start = start;\r\n");
      out.write("\t\t\tthis.end = end;\r\n");
      out.write("\t\t\tthis.total = total;\r\n");
      ...
      out.write("\t\t        \tsuccess : function(data){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t        \t\t//화면에 뿌리기전에  인포윈도우를 지워서 초기화\r\n");
      out.write("\t\t    \t    \tfor(var i=0; i<infowindow.length; i++){\r\n");
      out.write("\t\t    \t    \t\tif(infowindow[i] !== undefined){\r\n");
      out.write("\t\t    \t    \t\t\tinfowindow[i].setMap(null);\t\r\n");
      out.write("\t\t    \t    \t\t\tinfowindow[i]= null; \r\n");
      out.write("\t\t    \t    \t\t}\r\n");
      out.write("\t\t    \t    \t}\r\n");
      out.write("\t\t    \t    \tinfowindow = new Array();\r\n");
      out.write("\t\t        \t\t\r\n");
      out.write("\t\t\t          \tif(data.list !== undefined){ //결과들을 마커로 생성하기\r\n");
      out.write("\t\t\t          \t\tfor(var i=0; i<data.list.length; i++){\r\n");
      out.write("\t\t\t          \t\t\tdata.list[i].place_name = decodeURIComponent(data.list[i].place_name);\t          \t\t\t\t          \t\t\t\r\n");
      ...
      out.write("\t\t\t          \t\t}\r\n");
      out.write("\t\t\t          \t\t  \t\t\r\n");
      out.write("\t\t\t          \t\tpage.current = Number(data.list[0].currentPage);\r\n");
      out.write("\t\t\t          \t\tpage.max = Number(data.list[0].maxPage);\r\n");
      out.write("\t\t\t          \t\tpage.start = Number(data.list[0].startPage);\r\n");
      out.write("\t\t\t          \t\tpage.end = Number(data.list[0].endPage);\r\n");
      out.write("\t\t\t          \t\tpage.total = Number(data.list[0].totalCount);          \t\t    \t\t\r\n");
      out.write("\t\t\t          \t\tdisplayPlaces(data.list); \r\n");
      out.write("\t\t\t          \t\t//검색시  자동으로 1번 마커 클릭 표시\r\n");
      out.write("\t\t\t                daum.maps.event.trigger(markers[0], \"click\"); //강제로 클릭 발생\r\n");
      out.write("\t\t\t                displayInfowindow(markers[0], data.list[0].place_name, data.list[0].boardNo, data.list[0].thumbnail_name, data.list[0].title, data.list[0].contents, 0);   //처음엔 인포창 생성해야 함 (mouseover 이벤트로 발생되는게 아니기 때문에)          \t\t\r\n");
      out.write("\t\t\t          \t\tdisplayPagination(page);\r\n");
      out.write("\t\t\t                    \t\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//페이지 클릭 이벤트\r\n");
      out.write("\t$(document).on(\"click\",\"#pagination a\", function(){\r\n");
      out.write("\t\tconsole.log($(this));\r\n");
      out.write("\t    if($(this).hasClass(\"tofirstpage\")){\t\t\t\t    \r\n");
      out.write("\t    \tpage.gotoPage(Number(1));\r\n");
      out.write("\t    \treturn false;\r\n");
      out.write("\t    }\r\n");
      out.write("\t    if($(this).hasClass(\"tolastpage\")){\r\n");
      out.write("\t    \tpage.gotoPage(Number(page.max));\r\n");
      out.write("\t    \treturn false;\r\n");
      out.write("\t    }\r\n");
      out.write("\t    if($(this).hasClass(\"toprevpage\")){\r\n");
      out.write("\t    \tpage.gotoPage(Number(page.start-5));\r\n");
      out.write("\t    \treturn false;\r\n");
      out.write("\t    }\r\n");
      out.write("\t    if($(this).hasClass(\"tonextpage\")){\r\n");
      out.write("\t    \tpage.gotoPage(Number(page.start+5));\r\n");
      out.write("\t    \treturn false;\r\n");
      out.write("\t    }\r\n");
      out.write("\t  \r\n");
      out.write("\t\tpage.gotoPage(Number($(this).html()));\r\n");
      out.write("\t \t\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t    el.href=\"#\";\r\n");
      out.write("\t    el.innerHTML = \"&laquo;\";\r\n");
      out.write("\t    $(el).addClass(\"tofirstpage\");\r\n");
      out.write("\t    if(pagination.current <= 1){\r\n");
      out.write("\t    \t$(el).addClass(\"on\");\r\n");
      out.write("\t    \t$(el).css(\"pointer-events\", \"none\");\r\n");
      out.write("\t    }\t    \t    \r\n");
      ...
      out.write("\t    $(el).addClass(\"toprevpage\");\r\n");
      out.write("\t    if(!((pagination.current-5)<pagination.start && (pagination.current-5)>=1)){\r\n");
      out.write("\t    \t$(el).addClass(\"on\");\t    \t\r\n");
      out.write("\t    \t$(el).css(\"pointer-events\", \"none\");\r\n");
      out.write("\t    }\t    \t    \r\n");
      out.write("\t    fragment.appendChild(el);\r\n");
      out.write("\t    \r\n");
      out.write("\t    for (i=pagination.start; i<=pagination.end; i++) {\r\n");
      out.write("\t    \t\r\n");
      out.write("\t        var el = document.createElement('a');\r\n");
      out.write("\t        el.href = \"#\";\r\n");
      ...
      out.write("\t    el.href=\"#\";\r\n");
      out.write("\t    el.innerHTML = \"&gt;\";\r\n");
      out.write("\t    $(el).addClass(\"tonextpage\");\r\n");
      out.write("\t    if(!((pagination.current+5)>pagination.end && (pagination.start + 5)<=pagination.max)){\r\n");
      out.write("\t    \t$(el).addClass(\"on\");\t    \t\r\n");
      out.write("\t    \t$(el).css(\"pointer-events\", \"none\");   \t\r\n");
      out.write("\t    }\r\n");
      out.write("\t    fragment.appendChild(el);    \r\n");
      ...
      out.write("\t    var el = document.createElement('a');\r\n");
      out.write("\t    el.href=\"#\";\r\n");
      out.write("\t    el.innerHTML = \"&raquo;\";\r\n");
      out.write("\t    $(el).addClass(\"tolastpage\");\r\n");
      out.write("\t    if(pagination.current >= pagination.max){\r\n");
      out.write("\t    \t$(el).addClass(\"on\");\t    \t\r\n");
      out.write("\t    \t$(el).css(\"pointer-events\", \"none\");\r\n");
      out.write("\t    }\t    \t    \r\n");
      out.write("\t    fragment.appendChild(el);\r\n");
      ...
      out.write("\t            \t\t\t\tif(infowindow[placelistclicked] !== undefined){\r\n");
      ...
      out.write("\t\t\tthumbnail_name = '/mimi/resources/images/main/img3.jpg';\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse{\r\n");
