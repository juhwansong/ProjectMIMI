 ...
 * Generated at: 2018-08-28 12:02:00 UTC
...
public final class customer1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(userId == null){
      ...
      out.write("\t\t  if (form.word.value == '' || form.word.value == null){\r\n");
      out.write("\t\t   alert('검색어를 입력하세요.');\r\n");
      out.write("\t\t   form.word.focus();\r\n");
 ...
 for(Support s : slist) { 
      out.write("\r\n");
      out.write("\t\t<tr align=\"center\" onclick=\"FaqToggleDetail( 'row_");
 ...
 for(Support s : slist) { 
      ...
      out.write("'\" name=\"btnModify\" style=\"outline:none; padding: 7px; margin:2px;\">수정</button>\r\n");
      out.write("\t<br><br>\r\n");
      out.write("\t\t\t\t<!-- 댓글 불러오기 -->\r\n");
      ...
      out.print(s.getBoardNo());
      out.write("');\"   value=\"댓글작성\" style=\"outline:none\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t</td>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<div style=\"padding:10px 50px 10px 50px; border:0px; min-height:auoto; width:100%;\">';               \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<div class=\"commentInfo'+value.cno+'\">'+'댓글번호 : '+value.cno+' / 작성자 : '+value.cwriter;                \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<a onclick=\"commentUpdate('+value.cno+',\\''+value.comment+'\\');\"> 수정 </a>';                \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<a onclick=\"commentDelete('+value.cno+');\"> 삭제 </a> </div>';                \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<div class=\"commentContent'+value.cno+'\"> <p> 내용 : '+value.comment +'</p>';                \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '</div></div>';     \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t});     \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t */\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar bno = \"\"; //게시글 번호 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar insertData = $('#comment').val(); //comment의 내용을 가져옴    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tcommentInsert(insertData); //Insert 함수호출(아래)});   //댓글 목록 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t//댓글 등록\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t/* //댓글 수정 - 댓글 내용 출력을 input 폼으로 변경 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfunction commentUpdate(cno, content){   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar a ='';       \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<div class=\"input-group\">';    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<input type=\"text\" class=\"form-control\" name=\"content_'+cno+'\" value=\"'+content+'\"/>';    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '<span class=\"input-group-btn\"><button class=\"btn btn-default\" type=\"button\" onclick=\"commentUpdateProc('+cno+');\">수정</button> </span>';    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ta += '</div>';        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t$('.commentContent'+cno).html(a);    }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfunction commentUpdateProc(cno){    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar updateContent = $('[name=content_'+cno+']').val();        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t$.ajax({        url : '/comment/update',        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype : 'post',        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata : {'content' : updateContent, 'cno' : cno},        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tsuccess : function(data){           \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tif(data == 1)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tcommentList(bno); //댓글 수정후 목록 출력  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t//댓글 삭제 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfunction commentDelete(cno){   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t$.ajax({        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\turl : '/comment/delete/'+cno,       \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype : 'post',       \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tsuccess : function(data){         \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tif(data == 1) commentList(bno); //댓글 삭제후 목록 출력      \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}    */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t/* $(document).ready(function(){    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tcommentList(); //페이지 로딩시 댓글 목록 출력\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t});   */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</script>\r\n");
      out.write("\r\n");
