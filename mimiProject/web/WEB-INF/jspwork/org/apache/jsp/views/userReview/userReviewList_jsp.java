 ...
 * Generated at: 2018-08-30 22:33:13 UTC
...
public final class userReviewList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(userId == null){
      ...
      out.write("</script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tfunction callback(data){ //목록, 페이지네이션 처리\r\n");
      out.write("\t\t//console.log(\"콜백함수 실행중...\");\r\n");
      out.write("\t\tvar searchText = $(\"#search-text\").val();\r\n");
      out.write("\t\tvar jsonStr = JSON.stringify(data);\t\t\t\r\n");
      out.write("\t\tvar json = JSON.parse(jsonStr);\r\n");
      out.write("\t\tvar boradNoSub = \"\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#table\").empty(); //기존 목록 전부 지우기\r\n");
      out.write("\t\tvalues = \"<thead>\"\r\n");
      out.write("\t\t\t\t+ \"<tr><th width=\\\"8%\\\">글번호</th>\"\r\n");
      out.write("\t\t\t\t+ \"<th width=\\\"*\\\" colspan=\\\"2\\\">제목</th>\"\r\n");
      ...
      out.write("\t\t\tvalues += \"<tr><td>No.\"+json.list[i].boardNo.substring(2).replace(/^0*/gi,\"\")+\"</td>\"\r\n");
      out.write("\t\t\t\t\t+ \"<td style=\\\"width: 90px\\\"><a href=\\\"/mimi/userboarddetailview?bnum=\"+json.list[i].boardNo+\"&page=\"+ json.currentPage +\"\\\"><img class=\\\"img-thumb img-mover\\\"\"\r\n");
      out.write("\t\t\t\t\t+ \" src=\\\"\";\r\n");
      out.write("\t\t\tif(json.list[i].thumbnail != null){\r\n");
      out.write("\t\t\t\tvalues += \"/mimi\" + \"/resources/files/userboard/\"+ json.list[i].thumbnail + \"\\\"></a></td>\"; \r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tvalues += \"/mimi/resources/images/main/img3.jpg\\\"></a></td>\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tvalues += \"<td class=\\\"tbl-td-title\\\" style=\\\"vertical-align: middle;\\\"><a href=\\\"/mimi/userboarddetailview?bnum=\"\r\n");
      out.write("\t\t\t\t+ json.list[i].boardNo + \"&page=\"+ json.currentPage+\"\\\">\"+ json.list[i].title + \"&nbsp;&nbsp;&nbsp;\"\r\n");
      out.write("\t\t\t\t+ \"<span class=\\\"span-c\\\"><i class=\\\"fas fa-comments\\\"></i>&nbsp;\"+json.list[i].commentNum+\"</span></a></td>\"\r\n");
      out.write("\t\t\t\t+ \"<td>\"+ json.list[i].nickname + \"</td>\"\r\n");
      out.write("\t\t\t\t+ \"<td>\"+ json.list[i].boardDate + \"</td>\"\r\n");
      out.write("\t\t\t\t+ \"<td>\"+ json.list[i].hit + \"</td>\"\r\n");
      out.write("\t\t\t\t+ \"<td>\"+ json.list[i].recommend + \"</td>\"\r\n");
      out.write("\t\t\t\t+ \"</tr>\";\r\n");
      out.write("\t\t\t}\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\tvalues += \"</tbody>\"\r\n");
      out.write("\r\n");
      out.write("\t\t$(\"#table-css\").html(values); //목록 채우기\r\n");
      out.write("\r\n");
      out.write("\t\t//pagination\r\n");
      out.write("\t\t$(\"#userPagination\").empty(); //기존 페이지네이션 지우기\r\n");
      out.write("\t\tpageValues = \"\";\r\n");
      out.write("\t \t//<< 1\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t \t//< -10\r\n");
      out.write("\t\tif(json.maxPage == 0){ //결과없을때 비활성화\r\n");
      out.write("\t\t\tpageValues += '<span style=\"color:#ccc;\">&lt;</span></li>';\r\n");
      out.write("\t\t}else if((json.currentPage - 10) <= json.startPage && (json.currentPage - 10) > 1){\r\n");
      out.write("\t\t\tpageValues += '<a href=\"javascript:void(0)\" onclick=\"paging(' + (json.currentPage - 10) + ');\" title=\"이전\"><span style=\"color:#444;\">&lt;</span></a></li>';\t\r\n");
      out.write("\t\t}else if(json.currentPage != 1){ //1페이지 아니면 항상 활성화\r\n");
      out.write("\t\t\tpageValues += '<a href=\"javascript:void(0)\" onclick=\"paging(1);\" title=\"이전\"><span style=\"color:#444;\">&lt;</span></a></li>';\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tpageValues += '<span style=\"color:#ccc;\">&lt;</span></li>';\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t \t}else{ \r\n");
      out.write("\t\t \t\tpageValues += '<li><a href=\"javascript:void(0)\" onclick=\"paging(' + p + ');\"><span style=\"color:#444;\">' + p + '</span></a></li>';\r\n");
      out.write("\t\t\t}}\r\n");
      out.write("\t\t\r\n");
      out.write("\t \t//> +10\r\n");
      out.write("\t\tif((json.currentPage + 10) <= json.maxPage){\r\n");
      out.write("\t\t \tpageValues += '<li><a href=\"javascript:void(0)\" onclick=\"paging(' + (json.currentPage + 10) + ');\" title=\"다음\"><span style=\"color:#444;\">&gt;</span></a></li>';\r\n");
      out.write("\t\t}else if((json.currentPage + 10 ) > json.maxPage && json.currentPage < json.maxPage){ //마지막 페이지 아닐시 항상 활성화\r\n");
      out.write("\t\t\tpageValues += '<li><a href=\"javascript:void(0)\" onclick=\"paging(' + (json.maxPage) + ');\" title=\"다음\"><span style=\"color:#444;\">&gt;</span></a></li>';\r\n");
      out.write("\t\t}else{\r\n");
      ...
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tpageValues += '<li><a href=\"javascript:void(0)\" onclick=\"paging(' + json.maxPage + ');\" title=\"맨끝\"><span style=\"color:#444;\">&raquo;</span></a></li>';\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$(\"#userPagination\").html(pageValues);//페이지네이션\r\n");
      out.write("\t\t$('html, body').scrollTop(0); //상단으로 이동\r\n");
      out.write("\t}//callback function\t\t\r\n");
      out.write("\tfunction paging(p){\r\n");
      out.write("\t\tif($(\"#r-sort\").children().attr('class') === 'fas fa-sort-down'){//down 내림차순\r\n");
      out.write("\t\t\tvar sort = 'down';\r\n");
      out.write("\t\t}else if($(\"#h-sort\").children().attr('class') === 'fas fa-sort-down'){\r\n");
      out.write("\t\t\tvar sort = 'down';\r\n");
      out.write("\t\t}else if($(\"#d-sort\").children().attr('class') === 'fas fa-sort-down'){\r\n");
      out.write("\t\t\tvar sort = 'down';\r\n");
      out.write("\t\t}else if($(\"#r-sort\").children().attr('class') === 'fas fa-sort-up'){//up 오름차순\r\n");
      out.write("\t\t\tvar sort = 'up';\r\n");
      out.write("\t\t}else if($(\"#h-sort\").children().attr('class') === 'fas fa-sort-up'){\r\n");
      out.write("\t\t\tvar sort = 'up';\r\n");
      out.write("\t\t}else if($(\"#d-sort\").children().attr('class') === 'fas fa-sort-up'){\r\n");
      out.write("\t\t\tvar sort = 'up';\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#r-sort\").children().attr('class') != 'fas fa-sort'){\r\n");
      out.write("\t\t\tvar order = $(\"#r-sort\").children().attr('id');\r\n");
      out.write("\t\t}else if($(\"#h-sort\").children().attr('class') != 'fas fa-sort'){\r\n");
      out.write("\t\t\tvar order = $(\"#h-sort\").children().attr('id');\r\n");
      out.write("\t\t}else if($(\"#d-sort\").children().attr('class') != 'fas fa-sort'){\r\n");
      out.write("\t\t\tvar order = $(\"#d-sort\").children().attr('id');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tconsole.log(\"sort : \" + sort + \", order : \" + order);\r\n");
      out.write("\t\t$.ajax({\t\t\r\n");
      out.write("\t\t\turl : \"userboardsearch\",\r\n");
      out.write("\t\t\tdata : {category : categoryValue, keyword : searchText, order : order, sort : sort, page : p},\r\n");
      out.write("\t\t\ttype : \"post\",\r\n");
      ...
      out.write("\t\t\tcategoryValue = $(\"#select-category option:selected\").val();\r\n");
      out.write("\t\t\tsearchText = $(\"#search-text\").val();\r\n");
      out.write("\t\t\t//console.log(\"변경된 카테고리 값 : \" + categoryValue);\r\n");
      out.write("\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\turl : \"/mimi/userboardsearch\",\r\n");
      out.write("\t\t\t\tdata : {category : categoryValue, page : page},\r\n");
      out.write("\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\tdataType : \"json\",\r\n");
      out.write("\t\t\t\tsuccess : function(data){\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tcallback(data);\r\n");
      ...
      out.write("///////////////////////////////////////////////////////////////////////////////////////////////////////////////////\t \t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//검색버튼 클릭 시 ajax 실행\r\n");
      out.write("\t\t$(\"#submitBtn\").on('click', function search(){\r\n");
      out.write("\t\t\tcategoryValue = $(\"#select-category option:selected\").val();\r\n");
      out.write("\t\t\tsearchText = $(\"#search-text\").val();\r\n");
      out.write("\t\t\tconsole.log(searchText);\r\n");
      out.write("\t\t\t//console.log(\"버튼 실행 확인...\");\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\r\n");
      out.write("\t\t\t\turl : \"/mimi/userboardsearch\",\r\n");
      out.write("\t\t\t\tdata : {category : categoryValue, keyword : searchText, page : page},\r\n");
      out.write("\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\tdataType : \"json\",\r\n");
      out.write("\t\t\t\tsuccess : function(data){\t\r\n");
      out.write("\t\t\t\t\tcallback(data);\r\n");
      ...
      out.write("\t\t\t})//ajax\r\n");
      out.write("\r\n");
      out.write("\t\t\t//console.log(\"categoryValue : \" + categoryValue + \"\\nsearchText : \" + searchText);\r\n");
      out.write("\t\t})//submitBtn click\r\n");
      out.write("\r\n");
      out.write("///////////////////////////////////////////////////////////////////////////////////////////////////////////////////\t\r\n");
      out.write(" \r\n");
      out.write("\t\t//정렬 선택 시 ajax 실행\r\n");
      out.write("\t\t$(\"#r-sort, #h-sort, #d-sort\").on('click', function(){\r\n");
      out.write("\t\t\tvar icon = ($(this).children().attr('class') === 'fas fa-sort-down') ? 'fas fa-sort-up' : 'fas fa-sort-down'; \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//현재 선택영역 제외하고 나머지 원래 아이콘으로 변경\r\n");
      out.write("\t\t\t$(\"#r-sort, #h-sort, #d-sort\").children().not($(this).children()).attr('class', 'fas fa-sort');\r\n");
      out.write("\t\t\t$(this).children().prop('class', icon); //아이콘 바꾸기\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar sort = $(this).children().attr('class');\r\n");
      out.write("\t\t\tvar order = $(this).children().attr('id');\r\n");
      out.write("\t\t\tcategoryValue = $(\"#select-category option:selected\").val();\r\n");
      out.write("\t\t\tsearchText = $(\"#search-text\").val();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\turl : \"/mimi/userboardsearch\",\r\n");
      out.write("\t\t\t\tdata : {category : categoryValue, keyword : searchText, order : order, sort : sort, page : page},\r\n");
      out.write("\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\tdataType : \"json\",\r\n");
      out.write("\t\t\t\tsuccess : function(data){\r\n");
      out.write("\t\t\t\t\tcallback(data);\t\t\t\t\t\r\n");
      ...
      out.write("\t       $(\"#search-text\").keypress(function (e) {\r\n");
      out.write("\t        if (e.which == 13){\r\n");
      out.write("\t        \tdocument.getElementById(\"submitBtn\").click();;  // 실행할 이벤트\r\n");
      out.write("\t        }\r\n");
      out.write("\t    });\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
      ...
      out.write("table {\r\n");
      out.write("\ttext-align: center;\r\n");
      out.write("\tline-height: middle;\r\n");
      out.write("}\r\n");
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("<!-- <title>유저리뷰게시판</title> -->\r\n");
      out.write("\r\n");
      out.write("<div class=\"container\" style=\"width:1150px;\">\r\n");
      out.write("\t<h3>유저 리뷰</h3>\r\n");
      out.write("\t<hr class=\"margin1\" style=\"margin: auto auto 5px auto;\">\r\n");
      out.write("\t<div class=\"form-inline\" name=\"select\" id=\"select\" method=\"post\" action=\"#\">\r\n");
      out.write("\t\t<!-- 왼쪽 -->\r\n");
      out.write("\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t<select class=\"form-control\" id=\"select-category\">\r\n");
      out.write("\t\t\t\t<option value=\"C0\" selected disabled hidden>Category</option>\r\n");
      out.write("\t\t\t\t<option value=\"C0\">전체</option>\r\n");
      out.write("\t\t\t\t<option value=\"C1\">커피/디저트</option>\r\n");
      out.write("\t\t\t\t<option value=\"C2\">패스트푸드</option>\r\n");
      out.write("\t\t\t\t<option value=\"C3\">한식</option>\r\n");
      out.write("\t\t\t\t<option value=\"C4\">양식</option>\r\n");
      out.write("\t\t\t\t<option value=\"C5\">일식</option>\r\n");
      out.write("\t\t\t\t<option value=\"C6\">중식</option>\r\n");
      out.write("\t\t\t\t<option value=\"C7\">분식</option>\r\n");
      out.write("\t\t\t\t<option value=\"C8\">기타</option>\r\n");
      out.write("\t\t\t</select>&nbsp;&nbsp;&nbsp; <span style=\"color: #555; font-size: 12px;\">\r\n");
      out.write("\t\t\t<a href=\"javascript:void(0)\" id=\"r-sort\">추천수&nbsp;<i id=\"recommend\" class=\"fas fa-sort\"></i></a>&nbsp;&nbsp;&nbsp; \r\n");
      out.write("\t\t\t<a href=\"javascript:void(0)\" id=\"h-sort\">조회수&nbsp;<i id=\"hits\" class=\"fas fa-sort\"></i></a>&nbsp;&nbsp;&nbsp; \r\n");
      out.write("\t\t\t<a href=\"javascript:void(0)\" id=\"d-sort\">기간&nbsp;<i id=\"board_date\" class=\"fas fa-sort\"></i></a></span>\r\n");
      out.write("\t\t\t</span>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 오른쪽 -->\r\n");
      ...
      out.write("\t\t\t<button type=\"button\" id=\"submitBtn\" class=\"btn\" name=\"btn\" style=\"outline: none\">\r\n");
 ...
 for(Board rb : list){ 
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>No.");
      out.print( rb.getBoardNo().substring(2).replaceAll("^0*","") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td style=\"width: 90px\"><a href=\"/mimi/userboarddetailview?bnum=");
      out.print( rb.getBoardNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\"><img class=\"img-thumb img-mover\"\r\n");
      out.write("\t\t\t\t\t\t\tsrc=\"");
if(rb.getThumbnailName() != null){
      out.print(request.getContextPath());
      out.write("/resources/files/userboard/");
      out.print(rb.getThumbnailName());
}else{
      out.write("/mimi/resources/images/main/img3.jpg");
}
      out.write("\"></a></td>\r\n");
      ...
      out.write('"');
      out.write('>');
      out.print( rb.getTitle() );
      out.write("&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t<span class=\"span-c\"><i class=\"fas fa-comments\"></i>&nbsp;");
      out.print( rb.getCommentNum() );
      out.write("</span></a></td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( rb.getNickName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( rb.getBoardDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( rb.getHits() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( rb.getRecommed() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
 } 
      ...
      out.write("\t<tr>\r\n");
      out.write("\t\t<td width=\"30%\"></td><!-- 빈칸 -->\r\n");
      out.write("\t\t<td width=\"*\"><!-- 페이지 -->\r\n");
      out.write("\t<!-- Pagination -->\r\n");
      out.write("\t\t<ul class=\"pagination\" id=\"userPagination\" style=\"float: center; display: flex; justify-content: center;\">\r\n");
      out.write("\t\t<!--  맨처음 -->\r\n");
      out.write("\t\t");
  if(currentPage <= 1){ 
      out.write("\r\n");
      out.write("\t\t\t<li><span style=\"color:#ccc;\">&laquo;</span></li><li>\r\n");
      out.write("\t\t");
  }else{  
      out.write("\r\n");
      out.write("\t\t\t<li><a href=\"/mimi/userboardlist?page=1\" aria-label=\"Previous\" title=\"맨처음\"><span style=\"color:#444;\">&laquo;</span></a></li><li>\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t\r\n");
 ...
 if(maxPage == 0){ //결과없을떄 비활성화 
      out.write("\r\n");
      out.write("\t\t\t<span style=\"color:#ccc;\">&lt;</span></li>\r\n");
      out.write("\t\t");
 }else if((currentPage - 10) <= startPage && (currentPage - 10) > 1){ 
      out.write("\r\n");
      out.write("\t\t\t<a href=\"/mimi/userboardlist?page=");
      out.print( startPage - 10 );
      out.write("\" title=\"이전\"><span style=\"color:#444;\">&lt;</span></a></li>\t\r\n");
      out.write("\t\t");
 }else if(currentPage != 1){ //1페이지 아니면 항상 활성화
      out.write("\r\n");
      out.write("\t\t\t<a href=\"/mimi/userboardlist?page=1\" title=\"이전\"><span style=\"color:#444;\">&lt;</span></a></li>\r\n");
      out.write("\t\t");
 }else{ 
      out.write("\r\n");
      out.write("\t\t\t<span style=\"color:#ccc;\">&lt;</span></li>\r\n");
 ...
 for(int p = startPage; p <= endPage; p++){ 
				if(p == currentPage){ 
      out.write("\r\n");
      out.write("\t\t\t<li><a href=\"/mimi/userboardlist?page=");
      out.print( p );
 ...
 if(currentPage >= maxPage){ 
      ...
      out.write("\t\t\t<li><a href=\"/mimi/userboardlist?page=");
      out.print( maxPage );
      out.write("\"><span style=\"color:#444;\">&raquo;</span></a></li>\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t</ul>\t\r\n");
 ...
 if(userId != null){ 
      ...
      out.write("\t\t\tonClick=\"location.href='/mimi/views/userReview/userReviewInsert.jsp'\" value=\"글쓰기\" style=\"outline: none;\"></td>\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t</tr>\r\n");
